...
public class Login1 extends JFrame implements ActionListener{
   ...
   Panel06 p6;
   Panel07 p7;
   public Login1(MainFrame mf, Panel01 p1, Panel07 p7) {
      this.mf = mf;
      this.p1 = p1;
      this.p7 = p7;
   ...
   public Login1(MainFrame mf){
      ...
      log_btn.addActionListener(this);
      log_btn.setActionCommand("login"); //해당 버튼에 부여할 액션명령에 대한 명칭을 부여한다 //추가된 부분.
      join_btn.addActionListener(this);
      
      id_txt.addActionListener(this);
      id_txt.registerKeyboardAction(this, "login", KeyStroke.getKeyStroke(KeyEvent.VK_ENTER,0), JComponent.WHEN_FOCUSED); //추가된 부분
      pwd_txt.addActionListener(this);
      pwd_txt.registerKeyboardAction(this, "login", KeyStroke.getKeyStroke(KeyEvent.VK_ENTER,0), JComponent.WHEN_FOCUSED); //추가된 부분
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      if(e.getActionCommand() == "login"|| e.getSource() == log_btn) {//로그인버튼 눌렀을때 ( login 액션키인 모든 것 ) //변경된 부분
